...
## Purpose
Pre-publish on-page SEO checklist for every page or article. Run this before hitting publish on any new page, blog post, or landing page. Each item is a concrete, verifiable action.

## Source
Based on industry-standard on-page SEO best practices and Dutch SEO methodology.
