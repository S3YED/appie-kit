...
6. **API key in shell heredocs** — `source ~/.weblyfe-secrets/.env && python3 << 'PYEOF'` works. Writing keys into script files is risky and often produces syntax errors from the write_file tool.
