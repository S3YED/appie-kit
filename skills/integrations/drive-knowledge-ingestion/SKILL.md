...
description: >-
  ...
  knowledge graph → Neo4j export → Cognify memory integration →
  realtime dashboard. Disk-safe: media wordt alleen metadata, documenten
  download naar temp en verwijderen direct. Ontworpen voor 8GB+ constraints.
---
