...
## Reference files
- `references/full-site-seo-audit-checklist.md` — full-stack SEO audit workflow: source code + live browser + Google guidance cross-reference, with report template and critical checks.
