...
description: Port OpenClaw Appie to Hermes Agent and spawn new client or internal instances. Clone appie-brain, configure identity files (SOUL.md, USER.md, IDENTITY.md, AGENTS.md), set up git sync, copy secrets, configure beta WhatsApp/wacli access, and start Hermes gateway.
version: 1.0.0
author: Appie-3
