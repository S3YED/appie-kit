...
## Songwriting Craft & Prompt Engineering

For songwriting craft, lyric structure, rhyme schemes, Suno AI metatag engineering, and phonetic tricks for AI vocalists, see the `songwriting-and-ai-music` skill. That skill covers:

- Song structure (verse/chorus/bridge patterns)
- Rhyme types and meter
- Emotional arc and dynamics
- Suno AI style prompt engineering
- Metatags for vocal and dynamic control
- Parody and adaptation techniques

For audio analysis and spectrogram visualization, see the `songsee` skill.===ME:open-source-music-generation