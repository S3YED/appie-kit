...
## Where it is installed (v0.7.0, per host)

| Host | Python |
|---|---|
| Mac Mini (appie-1 / appie-3 / appie-4 / Opus) | `/Users/appie/clawd/external/.venv-turbovec/bin/python` |
| appie-2 (Hetzner) | `/root/venvs/turbovec/bin/python` |
| Spark Atlas | `~/venvs/turbovec/bin/python` |

Run scripts with that interpreter; do not pip-install elsewhere.
