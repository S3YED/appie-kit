...
### 14. Em Dash / Em Rule Overuse

**Problem:** LLMs use em dashes (—) more than humans, mimicking "punchy" sales writing.

**Global rule for customer-facing copy: NO em dashes.** Not "most" -- every single one. Replace with a period, comma, colon, middle-dot (·), or hyphen (-). This is a zero-tolerance style rule.

The problem is that em dashes in AI copy are a tell: they cluster in places a human would use a period or comma, adding an artificial "punchy" rhythm that signals LLM output. Even a single em dash in otherwise clean copy can break the illusion.
