...
| Tool | Location | Use |
|------|----------|-----|
| **playwright** | System install or npm | Browser automation |
| **puppeteer-extra + stealth** | npm | Bot-evasion browser |
| **httpx** | Python (pip) | Async HTTP |
| **requests** | Python (pip) | Simple HTTP |
...
Run: `python3 scripts/test-site.py https://example.com`
